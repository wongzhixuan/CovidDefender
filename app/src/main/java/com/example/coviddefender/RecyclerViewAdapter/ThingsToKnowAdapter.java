...
public class ThingsToKnowAdapter extends FirestoreRecyclerAdapter<Announcement, ThingsToKnowAdapter.ThingsToKnowViewHolder> {
    FirebaseStorage storage;
    StorageReference storageReference;
    public ThingsToKnowAdapter(@NonNull FirestoreRecyclerOptions<Announcement> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ThingsToKnowAdapter.ThingsToKnowViewHolder holder, int position, @NonNull Announcement model) {
    ...
    @NonNull
    @Override
    public ThingsToKnowAdapter.ThingsToKnowViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.things_to_do_item, parent, false);
        return new ThingsToKnowAdapter.ThingsToKnowViewHolder(view);
    }

    public class ThingsToKnowViewHolder extends RecyclerView.ViewHolder {
