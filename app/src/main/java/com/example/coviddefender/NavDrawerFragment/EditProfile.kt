...
class EditProfile : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btn_profile_details : MaterialButton = view.findViewById<MaterialButton>(R.id.btn_profile_details)
        ...
        val btn_profile_change_password : MaterialButton = view.findViewById<MaterialButton>(R.id.btn_profile_change_password)
